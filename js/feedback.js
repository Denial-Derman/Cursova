document.addEventListener('DOMContentLoaded', function () {
   ...
   const feedbackFormHTML = '<div class="feedback"><? $previous_page = $_SERVER["HTTP_REFERER"]; header("Location: $previous_page"); exit;?>   <form action="feedback_form.php" method="post" class="feedback__form" onsubmit="return actForm()">  <div class="feedback__form-close"><img src="img/feedback/close.svg" alt=""></div>  <div class="feedback__form-title"> <h2>Залишити контакти</h2> <p>Напишіть ваш номер телефону, щоб ми могли з вами зв’язатися</p>  </div> <div class="feedback__form-content">   <div class="feedback__form-name">  <p>Ім’я:</p>  <input type="text" name="feedbackName" id="feedbackName" placeholder="Ім’я"                        class="feedback__form-input"> </div>  <div class="feedback__form-number">   <p>Телефон:</p>  <input type="tel" name="feedbackNumber" id="feedbackNumber" placeholder="+380(00)-000-00-00"   class="feedback__form-input">  </div>  <div class="feedback__form-send"> <button type="submit" class="feedback__form-input feedback__form-btn">Надіслати</button>  </div>   </div> </form> </div>';
